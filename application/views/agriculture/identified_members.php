...
<ul class="list-unstyled">
    ...
    <li class=""><a href="<?=base_url()?>agriculture/loadMembers"> <i class="fa fa-bar-chart"></i>Members</a></li>
    <li class="active"><a href="<?=base_url()?>agriculture/load_identified_members"> <i
    ...
    <div class="content-inner">
        ...
        <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Identified Members</li>
            </ul>
        </div>
