...
<ul class="list-unstyled">
    <li class="active"><a href="<?=base_url()?>city_authority/dashboard"> <i class="icon-home"></i>Home</a></li>
    <li><a href="<?=base_url()?>city_authority/addMembers"> <i class="icon-grid"></i>Add Members</a></li>
    <li><a href="<?=base_url()?>city_authority/loadMembers"> <i class="fa fa-bar-chart"></i>Members</a></li>
                ...
                <div class="row bg-white has-shadow">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="item d-flex align-items-center">
                            ...
                            <div class="title"><span>All<br>Transactions</span>
                                <div class="progress">
